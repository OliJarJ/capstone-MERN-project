...
<div className="container">
  ...
  <div className=" col-lg-6 col-xl-6 col-md-6 col-xs-12 col-sm-12">
    ...
    <div className="col-lg-6 col-xl-6 col-md-6 col-xs-12 col-sm-12">
      <img src={dogwithcouple} className="img-fluid border border-secondary" alt="An older couple and their pet dog."/>
    </div>
  ...
  <div className="text-center">
    <a href="/pets" className="btn btn-primary btn-lg btn-3d my-4 portfolio-button">Explore Adoptions</a>
  </div>
</div>
